...
import com.yes.Ahh.util.FluidJSONUtil;
...
public class GemInfusingStationRecipe implements Recipe<SimpleContainer> {
    ...
    public static class Serializer implements RecipeSerializer<GemInfusingStationRecipe> {
        ...
        public static final ResourceLocation ID =
                new ResourceLocation(AhhModMain.MODID, "gem_infusing");
        ...
        @Override
        public @Nullable GemInfusingStationRecipe fromNetwork(ResourceLocation pRecipeId, FriendlyByteBuf buf) {
